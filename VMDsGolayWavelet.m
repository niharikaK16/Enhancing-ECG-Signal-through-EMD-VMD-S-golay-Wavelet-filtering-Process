...
% Transpose 'u' for easier processing if needed
...
% Apply Discrete Wavelet Transform for further denoising each mode

waveletName = 'db4'; 

for i = 1:K

[c, l] = wavedec(u(:, i), 5, waveletName); % 5
...
title('Denoised ECG Signal (VMD + S-Golay + Wavelet)');
